        ...
        if (cordova.platformId == 'android') {
            describe('content: URLs', function() {
                ...
                it("file.spec.138 copyTo: content", function(done) {
                    testContentCopy('content://org.apache.cordova.file.testprovider/www/pastIndex.html', done);
                });
                ...
                it("file.spec.140 delete: content should fail", function(done) {
                    resolveLocalFileSystemURL('content://org.apache.cordova.file.testprovider/www/pastIndex.html', function(entry) {
            ...
            describe('asset: URLs', function() {
                ...
                it("file.spec.143 copyTo: asset -> temporary", function(done) {
                    ...
                    transfer = function () {
                        resolveLocalFileSystemURL('file:///android_asset/www/pastIndex.html', function(entry) {
